...
public class ReportWebService {
	...
	/**
	 * Run a report with parameters. Path is relative to nextserver root
	 * ('/nextServer'). Ex: '/reports/test' <=> '/nextServer/reports/test'
	 *
	 * @param runReportMetaData
	 *            runReportMetaData
	 * @return documentUrl
	 */
	@POST
	...
	public String runReport(RunReportMetaData runReportMetaData) {
		...
		if (LOG.isDebugEnabled()) {
			LOG.debug("Run report web service params = {" + runReportMetaData + "}");
