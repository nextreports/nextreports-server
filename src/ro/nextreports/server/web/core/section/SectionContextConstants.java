 ...
 * @author Decebal Suiu
 */
public interface SectionContextConstants {

    public static final String CURRENT_PATH = "currentPath";
    
    public static final String SELECTED_ENTITY_PATH = "slectedEntityPath";
    public static final String SELECTED_ENTITY_CHILDREN = "selectedEntityChildren"; 
