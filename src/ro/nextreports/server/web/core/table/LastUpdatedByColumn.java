...
public class LastUpdatedByColumn  extends PropertyColumn<Entity> {
    ...
    public LastUpdatedByColumn() {
        super(new Model<String>(new StringResourceModel("ActionContributor.Search.entityModified", null).getString()), "lastUpdatedBy", "lastUpdatedBy");
    }
