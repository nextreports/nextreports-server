...
public class IndicatorWidget extends EntityWidget {

	private static final long serialVersionUID = 1L;
	
	public static final String DEFAULT_TITLE = "Indicator";
    ...
    public WidgetView createView(String viewId, boolean zoom) {
		...
		return new IndicatorWidgetView(viewId, new WidgetModel(getId()), zoom); // dynamic;
	}
    ...
    public WidgetView createView(String viewId, boolean zoom, Map<String,Object> urlQueryParameters) {
 		...
 		return new IndicatorWidgetView(viewId, new WidgetModel(getId()), zoom, urlQueryParameters); // dynamic;
    }
