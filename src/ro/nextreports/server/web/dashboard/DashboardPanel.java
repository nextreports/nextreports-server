...
public class DashboardPanel extends GenericPanel<Dashboard> {
	...
	private final ResourceReference HTML2CANVAS_JS = new JavaScriptResourceReference(DashboardPanel.class, "html2canvas-0.5.0.js");
	private final ResourceReference JSPDF_JS = new JavaScriptResourceReference(DashboardPanel.class, "jspdf.min-1.0.272.js");
	...
	public DashboardPanel(String id) {
		this(id, new SelectedDashboardModel());						  
    }
	...
	public DashboardPanel(String id, IModel<Dashboard> model, boolean viewToolbar) {
		super(id, model);
...
//	                    target.add(globalSettingsLink);	      
		...
		toolbarContainer.add(new AjaxLink<Void>("pdf") {
			...
			private String getPdfJavascriptCall() {					
				...
				sb.append("pdfSettings.footerText = \"Generated by NextReports " + new SimpleDateFormat().format(new Date())+ "\";");
