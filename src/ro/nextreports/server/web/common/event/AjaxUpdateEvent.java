...
/**
 * Very simple event mechanism for loose coupling of wicket components for ajax updates.
 * 
 * @author Decebal Suiu
 */
public class AjaxUpdateEvent {
	...
	/**
	 * Fire this event, i.e. notify listeners. This is done by visiting all children of the 
	 * source component's page.
	 */
