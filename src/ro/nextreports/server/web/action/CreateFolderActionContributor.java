...
//
public class CreateFolderActionContributor extends SingleActionContributor {
	
	public static final String ID = CreateFolderActionContributor.class.getName();
    ...
    public String getActionName() {
        return new StringResourceModel("ActionContributor.AddFolder.name", null).getString();
    }
    ...
    public AbstractLink getLink(ActionContext context) {
        return new CreateFolderActionLink(context);
    }
