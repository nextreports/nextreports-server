...
//
public class UploadChartActionContributor extends SingleActionContributor {
	
	public static final String ID = UploadChartActionContributor.class.getName();
    ...
    public String getActionImage() {
        return "images/chart_new.png";
    }

    public String getActionName() {
        return new StringResourceModel("ActionContributor.UploadChart.name", null).getString();
    }
    ...
    public AbstractLink getLink(ActionContext context) {
        return new UploadChartActionLink(context);
    }
