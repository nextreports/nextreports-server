 ...
 * @author Decebal Suiu
 */
public class CreateDataSourceActionLink extends ActionAjaxLink {

	public CreateDataSourceActionLink(ActionContext actionContext) {
		super(actionContext);
	}
    ...
    public void executeAction(AjaxRequestTarget target) {
        ...
        panel.forwardWorkspace(new DataSourcePanel("work", entity.getPath()), target);

        //setResponsePage(new DataSourcePage(entity.getPath()));
    }
