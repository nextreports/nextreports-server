...
//
public class CreateDataSourceActionContributor extends SingleActionContributor {
	
	public static final String ID = CreateDataSourceActionContributor.class.getName();
    ...
    public String getActionName() {
        return new StringResourceModel("ActionContributor.DataSource.create", null).getString();
    }
    ...
    public AbstractLink getLink(ActionContext context) {
        return new CreateDataSourceActionLink(context);
    }
