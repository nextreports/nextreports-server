 ...
 * @author Decebal Suiu
 */
public class CreateUserActionLink extends ActionAjaxLink {

	public CreateUserActionLink(ActionContext actionContext) {
		super(actionContext);
	}
    ...
    public void executeAction(AjaxRequestTarget target) {
        ...
        panel.forwardWorkspace(new UserPanel("work", entity.getPath()), target);

        //setResponsePage(new UserPage(entity.getPath()));
    }
