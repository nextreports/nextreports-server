 ...
 * @author Decebal Suiu
 */
public class CreateGroupActionLink extends ActionAjaxLink {

	public CreateGroupActionLink(ActionContext actionContext) {
		super(actionContext);
	}
    ...
    public void executeAction(AjaxRequestTarget target) {
        ...
        panel.forwardWorkspace(new GroupPanel("work", entity.getPath()), target);

        //setResponsePage(new GroupPage(entity.getPath()));
    }
