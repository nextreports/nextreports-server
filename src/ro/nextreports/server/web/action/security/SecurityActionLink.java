 ...
 * @author Decebal Suiu
 */
public class SecurityActionLink extends ActionAjaxLink {

	public SecurityActionLink(ActionContext actionContext) {
		super(actionContext);
	}
    ...
    public void executeAction(AjaxRequestTarget target) {
        ...
        try {
            ...
            panel.forwardWorkspace(new SecurityPanel("work", entity), target);
