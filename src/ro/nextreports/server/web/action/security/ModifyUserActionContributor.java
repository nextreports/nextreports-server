 ...
 * @author Decebal Suiu
 */
public class ModifyUserActionContributor extends SingleActionContributor {
	
	public static final String ID = ModifyUserActionContributor.class.getName();

	public boolean support(Entity entity) {
		if (entity instanceof User) {
			String realm = ((User)entity).getRealm();
	...
	public AbstractLink getLink(ActionContext context) {
		return new ModifyUserActionLink(context);
	}
