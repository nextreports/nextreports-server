 ...
 * @author Decebal Suiu
 */
public class RenameActionContributor extends SingleActionContributor {
	
	public static final String ID = RenameActionContributor.class.getName();
    ...
    public AbstractLink getLink(ActionContext context) {
        return new RenameActionLink(context);
    }
