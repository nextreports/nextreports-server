 ...
 * @author Decebal Suiu
 */
public class UploadJasperReportActionLink extends ActionAjaxLink {

	public UploadJasperReportActionLink(ActionContext actionContext) {
		super(actionContext);
	}

    public void executeAction(AjaxRequestTarget target) {
        Entity entity = getActionContext().getEntity();
        //setResponsePage(new UploadJasperReportPage(entity.getPath()));
        ...
        panel.forwardWorkspace(new UploadJasperReportPanel("work", entity.getPath()), target);
