 ...
 * @author Decebal Suiu
 */
public class ScheduleActionLink extends ActionAjaxLink {

	public ScheduleActionLink(ActionContext actionContext) {
		super(actionContext);
	}
    ...
    public void executeAction(AjaxRequestTarget target) {
        ...
        try {
            ...
            ScheduleWizard wizard = new ScheduleWizard("work", report, false);
