...
import ro.nextreports.server.web.drilldown.DrillDownEntityPanel;


public class DrillDownActionLink extends ActionAjaxLink {

	public DrillDownActionLink(ActionContext actionContext) {
		super(actionContext);
	}
    ...
    public void executeAction(AjaxRequestTarget target) {
        ...
        try {
            ...
            panel.forwardWorkspace(new DrillDownEntityPanel("work", report), target);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
