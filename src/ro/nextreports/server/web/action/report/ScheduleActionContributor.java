 ...
 * @author Decebal Suiu
 */
public class ScheduleActionContributor extends SingleActionContributor {

	public static final String ID = ScheduleActionContributor.class.getName();
...
//        return "clock-o";
    ...
    public String getActionName() {
        return new StringResourceModel("schedule", null).getString();
    }
    ...
    public AbstractLink getLink(ActionContext context) {
    	return new ScheduleActionLink(context);
    }
