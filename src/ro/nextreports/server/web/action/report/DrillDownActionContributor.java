...
import ro.nextreports.server.web.action.report.DrillDownActionLink;
import ro.nextreports.server.web.core.action.ActionContext;
import ro.nextreports.server.web.core.action.SingleActionContributor;


public class DrillDownActionContributor extends SingleActionContributor {
	
	public static final String ID = DrillDownActionContributor.class.getName();
	...
	public String getActionName() {
		return new StringResourceModel("ActionContributor.Drill.name", null).getString();
	}
	...
	public AbstractLink getLink(ActionContext context) {
		return new DrillDownActionLink(context);
	}
