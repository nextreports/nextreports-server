 ...
 * @author Decebal Suiu
 */
public class DatabaseAuthenticationProvider extends ExternalAuthenticationProvider implements InitializingBean {
	
	private DaoAuthenticationProvider target;
